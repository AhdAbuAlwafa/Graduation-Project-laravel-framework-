...
<body>
    ...
    <div class="container">
        <form class="form-inline" style="justify-content: center; margin-right: -10px; margin-top: 100px;" method="GET"
            action="{{ route('userPage.mysearch') }}">
            @csrf
            <div class="container">

                <div class="row" style="align-items: center; margin-right: -400px;" dir="rtl">
        ...
        <section style="margin-top: 400px;" class="cardsection">
            ...
            <div class="card1">
                <form method="GET" action="{{route('userPage.getAllUser')}}">
                    @csrf
                    <div class="container">
                        <div class="row" style="align-items: center; margin-top: -500px; ; margin-right: -300px;"
                            dir="rtl">
                            @foreach($users as $user)

                            <div class="col-lg-4 col-md-12 col-12" data-role="user">
                                <div class="content">
                                    <div class=" card">
                                        <div class="card-content">
                                            ...
                                            <div class="button">
                                                <a href="{{ route('workerPage.showWorker', ['id' => $user->id]) }}"
                                                    class="btn btn-primary"> انتقل الى صفحة المهني</a>
