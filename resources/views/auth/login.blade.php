                    ...
                    <div class="box-register" id="register">
                        ...
                        <div class="row" style="margin-top: 10px;">
                            ...
                            <div class="gender-box">
                                ...
                                <div class="gender-option" >
                                    <div class="col-lg-2 col-md-12 col-12" > <h2>الجنس</h2></div>
                                    <div class="col-lg-2 col-md-12 col-12">
                                        <div class="gender">
                                            <input type='radio' id="check-male"  id="reg-user"
                                                name="gender" value="0" checked>
                                                <label for="check-male" style="font-size: 23px; margin-top: 5px;"> ذكر</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-2 col-md-12 col-12">
                                        <div class="gender">
                                            <input type='radio'  id="check-female" name="gender" id="reg-user"
                                                value="1">
                                                <label for="check-male" style="font-size: 23px; margin-top: 5px;"> انثى</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row"  >
                            <div class="input-field2">                  
                                ...
                                <label for="image" class='input-box2' class="form-label" style="height: 50px ; width: 350px; border-radius: 6px; border: 1px dashed black;" > اضافة صورة شخصية</label>
                            </div>
                        </div>
                         <!-------------------craft------------------------------->
                         ...
                         <div class="row">
                            <div class="col">
                                <input type="checkbox" id="workercheck" class="check" onclick="enabled(this)">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="input-field-left">
                                    <div class="select-country">
                                        <select  class='input-box-num' id="crafts"
                                            name="craft" style="color: #4e4e4e; visibility: hidden;">
                        ...
                        <div class="input-field-left">
                            <input type='text' class='input-box3' placeholder="وصف المهنه " id="reg-description"
                                name="description" style="visibility: hidden;" required>
                        </div>
                        <!---------------------------------submit------------------------------------->
                        <div class="input-field">
